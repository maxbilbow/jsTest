...
module.exports = {
    print: ezPrint,
    h0 : function(header){ hr(header,"><><><><><><><><><><")},
    h1 : function(header){ hr(header,"====================")},
    h2 : function(header){ hr(header,"--------------------")},
    h3 : function(header){ hr(header,">>>>>>>>>>>>>>>>>>>>")},
    h4 : function(header){ hr(header,"********************")},
    br : function(header) { lineBreak(header) }
};